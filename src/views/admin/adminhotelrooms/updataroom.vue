  ...
  <div class="banner">
    ...
    <el-form :model="ruleForm" status-icon ref="ruleForm" label-width="110px" class="demo-ruleForm" >
        ...
        <el-form-item label="房间号">
            <el-input v-model="ruleForm.rid" size="small" :disabled="true"></el-input>
        </el-form-item>
...
export default {
    ...
    mounted() {
              ...
              this.ruleForm.floor = this.$route.query.floor;
              this.ruleForm.type = this.$route.query.type;
              this.ruleForm.time1 = this.$route.query.time1;
              this.ruleForm.time2 = this.$route.query.time2;
    ...
    methods: {
        ...
        async submitForm() {
            ...
            const response = await this.$axios.post('http://192.168.1.115:8080/admin/updateRoom', 
            {
